...
export const HomePage = () => {
  return (
    <div className="about-container">
      <h1>About Our Cocktail Page 🍸</h1>

      <section className="about-intro">
        <p>
          <strong>Welcome to our cocktail page!</strong> Here you will find a
          variety of cocktail recipes to try at home. This react based project
          was built by two students exploring front-end development and trying
          out concepts such as components, routing and API integration.
        </p>
      </section>
